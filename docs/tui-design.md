...
## 12. Mockup'lar — ÖNERİ (gruplu model; kutu genişlikleri denetlendi)

Lejant: `►` seçim — kütüphane (ters video), `›` hover — ÖZEL gerçeklem (kalın, §3), `*` onay ister (çıkış dahil),
`★` güncelleme mevcut, `▸` alt grup girişi. Renk mockup'ta görünmez.

### 120x30 · çalışıyor (ÖNERİ: gruplu işlemler)
```
┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  OmniRoute 3.8.49  tr/koyu  12:00:00                                                                  │
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
### 120x30 · durdu (ÖNERİ: gruplu işlemler)
```
┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  OmniRoute 3.8.49  tr/koyu  12:00:00                                                                  │
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
### 120x30 · fare-hover (ÖNERİ: seçim Yeniden Başlat'ta, ÖZEL hover Bakım'da — §3)
```
┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  OmniRoute 3.8.49  tr/koyu  12:00:00                                                                  │
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
### 80x24 · çalışıyor (ÖNERİ: gruplu, odak İşlemler'de)
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/koyu  12:00:00                                            │
└──────────────────────────────────────────────────────────────────────────────┘
┌┤ Durum ├─────────────────────────────────────────────────────────────────────┐
│Durum      ● Çalışıyor                                                        │
│Versiyon   3.8.49                                                             │
...
╚══════════════════════════════════════════════════════════════════════════════╝
┌┤ Kayıtlar ▲ 4/4 (panel) ├────────────────────────────────────────────────────┐
│[12:00:02] INFO: sağlık sondası yanıt verdi (200)                             │
│[12:00:03] WARN: kurtarma beklemesi aktif (3 deneme)                          │
...
### 80x24 · durdu (ÖNERİ: gruplu, boş kayıt odası)
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/koyu  12:00:00                                            │
└──────────────────────────────────────────────────────────────────────────────┘
...
### 80x24 · Bakım alt grubu (ÖNERİ: ayrı List, Enter/tık açar, Esc geri)
```
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/koyu  12:00:00                                            │
...
### 80x24 · Ayarlar alt grubu (ÖNERİ: ayrı List)
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/koyu  12:00:00                                            │
└──────────────────────────────────────────────────────────────────────────────┘
...
### 80x24 · yardım penceresi (ÖNERİ: gruplu liste)
```
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/koyu  12:00:00                                            │
...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ OrPanel vX.Y.Z  tr/açık  12:00:00                                            │
└──────────────────────────────────────────────────────────────────────────────┘
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
...
### (kaynak: reddedilen tasarım — düz liste, yalnızca kayıt için)

Aşağıdaki kareler v1.4.5'in reddedilen düz-listesini belgeler; öneri
değildir. Yeni kareler yukarıdadır.
> düz liste: Durdur / Yeniden Başlat / ★ Güncelle / Onar / Web Arayüzü /
> Otomatik Başlat / Dil / Tema — çelişkili çiftleri gizlemez, `… +N` sessiz kırpar.

## 13. Onay için sorular (sahibine)

1. `açık` palet terminalinde okunuyor mu? (göz onayı — §5)
2. `sistem` paletinde marka renklerinden vazgeçmek kabul mü? (§5)
3. `List` başına seçim stili (`SetSelectedStyle`) onayın mı? (§9)
